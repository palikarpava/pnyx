...
if ( ! class_exists( 'TP_Template' ) ) :
	...
	abstract class TP_Template {
		...
		public function buttons() {
			...
			elseif ( $this->current === 'follow_up_form' ):
				$buttons['submit'] = clone $button;
				$buttons['submit']->attributes(
					array(
						array( 'name', 'totalpoll[action]' ),
						array( 'value', 'follow_up' ),
						//array( 'onclick', 'EmailForm.submit(event, this)' ),
						array( 'class', 'totalpoll-button totalpoll-button-primary totalpoll-button-proceed' ),
					)
				)->inner( __( 'Submit', TP_TD ) );
			endif;
		...
		public function hidden_fields() {
			...
			if(isset($limitations['date']['enabled']) && $limitations['date']['enabled'] == 'on' && isset($limitations['date']['end'])) {
				$enddate=esc_attr( date( 'm/d/Y H:i', (int) $limitations['date']['end'] ) );

				$fields['enddate'] = clone $field;
				$fields['enddate']->attributes(
					array(
						array('type', 'hidden'),
						array('name', 'limitations[date][end]'),
						array('value', $enddate),
						array('class', 'enddate'),
					)
				);
